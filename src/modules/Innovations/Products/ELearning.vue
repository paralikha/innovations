                ...
                <v-card flat class="pt-4 transparent">
                  <v-card-text>
                    ...
                    <p class=" font__weight--bold mb-3">
                      {{ trans('As advocates of lifelong career progressions, our aim is to help anyone with the same purpose. For you who constantly seek to enhance efficiency and value, we will help fix performance gaps through relevant e-Learning programmes suited to meet the demands of today\'s economy.') }}
                    </p>
                    <v-btn color="secondary">{{ trans('Learn More') }}</v-btn>
                  </v-card-text>
                </v-card>
              </v-layout>
            </v-flex>
        ...
        <v-flex xs12>
          <v-card flat class="hidden-sm-and-down text-xs-center py-5">
            <video loop width="80%" height="auto" controls>
              <source :src="require('@/assets/videos/elearning-demo.mp4')" type="video/mp4">
...
import ELearningSvg from '@/assets/images/ELearningBanner.png'
