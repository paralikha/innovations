<template>
  <body>
    <div class="error__page--gradient">
      <div class="stars">
        <div class="star"></div>
        <div class="star"></div>
        <div class="star"></div>
...
.circle--outer {
  width: 550px;
  height: 550px;
  background-image: linear-gradient(to right bottom, rgba(128, 43, 137, 0.16), rgba(86, 49, 161, 0.25));
}
.circle--inner {
  width: 355px;
  height: 355px;
